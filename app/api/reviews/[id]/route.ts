...
import { createUnauthorizedResponse, createBadRequestResponse, createServerErrorResponse, createNotFoundResponse } from '@/lib/apiErrors'
...
export async function PUT(
  ...
  try {
    ...
    await updateProductRating(existingReview.productId, existingReview.productType)
