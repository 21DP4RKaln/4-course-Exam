      ...
      if (reviews.length > 0) {
        return NextResponse.json({
          reviews: reviews.map(review => ({
            ...
            rating: review.rating,
            comment: review.comment || 'Great service! Very professional team and excellent products.',
      ...
      reviews: [
        {
          name: "John Smith",
          rating: 5,
          comment: "Fantastic service! My gaming PC works better than expected and the team was very professional.",
        ...
        },
        {
          name: "Anna Berzina",
          rating: 5,
          comment: "Great experience from start to finish. My custom workstation is perfect for graphic design work.",
          date: new Date().toISOString(),
          profileImage: null
        },
        {
          name: "Matiss K.",
          rating: 4,
          comment: "Very happy with my new PC build. Delivery was fast and setup was straightforward.",
          date: new Date().toISOString(),
          profileImage: null
        }
      ],
      ...
      reviews: [
        {
          name: 'Roberts L.',
          rating: 5,
          comment: 'Exceptional service! My gaming setup is amazing and the team was very helpful with all my questions.',
          date: new Date().toISOString(),
          profileImage: null
        },
        {
          name: 'Marta P.',
          rating: 5,
          comment: 'Very professional team and excellent products. Would definitely recommend to anyone looking for a custom PC.',
          date: new Date().toISOString(),
          profileImage: null
        },
        {
          name: 'Toms K.',
          rating: 4,
          comment: 'Great experience with IvaPro! My custom PC works perfectly for both gaming and development work.',
          date: new Date().toISOString(),
          profileImage: null
        }
      ],
