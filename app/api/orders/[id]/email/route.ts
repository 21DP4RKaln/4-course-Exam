...
import { createServerErrorResponse, createBadRequestResponse, createNotFoundResponse } from '@/lib/apiErrors'
...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  try {   
    ...
    if (!emailSent) {
      return createServerErrorResponse('Failed to send order confirmation email');
    }
