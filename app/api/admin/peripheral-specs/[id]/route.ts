...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to fetch peripheral specification' },
      { status: 500 }
    );
  }
}
...
export async function PUT(
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Failed to update peripheral specification' },
      { status: 500 }
    );
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    return NextResponse.json(
      {
        message:
          'Deleting peripheral specifications is not supported in this version. ' +
    ...
    console.error(
      'Error handling peripheral specification delete request:',
      error
    );
    return NextResponse.json(
