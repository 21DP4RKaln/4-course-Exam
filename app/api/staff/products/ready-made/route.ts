...
export async function GET(request: NextRequest) {
  try {
    ...
    const categories = [
      ...
      { id: 'office', name: 'Office PC', description: 'Business and office computers' },
      { id: 'budget', name: 'Budget PC', description: 'Affordable everyday computers' }
    ]
