  ...
  try {
    ...
    const formattedPeripherals = peripherals.map(peripheral => {
      ...
      if (peripheral.microphone) {
        ...
        specifications['Sensitivity'] = `${peripheral.microphone.sensitivity}dB`
        specifications['Interface'] = peripheral.microphone.interface
        specifications['Stand Included'] = peripheral.microphone.stand ? 'Yes' : 'No'
      ...
      if (peripheral.monitor) {
        ...
        specifications['Response Time'] = `${peripheral.monitor.responseTime}ms`
      ...
      if (peripheral.speakers) {
        ...
        specifications['Total Wattage'] = `${peripheral.speakers.totalWattage}W`
    ...
    return NextResponse.json({
      peripherals: formattedPeripherals,      categories: categories.map(cat => ({
        id: cat.id,
        name: cat.name,
