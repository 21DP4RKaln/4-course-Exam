    ...
    try {
      const payload = {
        ...
        estimatedCost: editData.estimatedCost
          ? parseFloat(editData.estimatedCost)
          : undefined,
        finalCost: editData.finalCost
          ? parseFloat(editData.finalCost)
          : undefined,
      };
    ...
    return (
      <div className="p-6 bg-red-50 border border-red-200 rounded-lg">
        ...
        <p className="text-red-700">
          {error || 'Failed to load repair details'}
        </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value: RepairPriority) =>
                ...
                <CardContent className="space-y-4">
                  ...
                  {repair.diagnosticNotes && (
                    <div className="mt-4 p-4 bg-blue-50 dark:bg-blue-950 rounded-lg">
                      ...
                      <p className="mt-1 text-blue-800 dark:text-blue-200 whitespace-pre-line">
                        {repair.diagnosticNotes}
                      </p>
                    </div>
                  )}
