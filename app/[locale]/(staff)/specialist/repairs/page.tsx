...
export default function RepairsPage() {
  ...
  const [priorityFilter, setPriorityFilter] = useState<'all' | RepairPriority>(
    'all'
  );
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-4 items-center">
        ...
        <select
          ...
          onChange={e =>
            setPriorityFilter(e.target.value as 'all' | RepairPriority)
          }
        >
      ...
      <div className="grid gap-4">
        ...
        {filteredRepairs.map(repair => (
          <Card
            key={repair.id}
            className={repair.priority === 'URGENT' ? 'border-red-500' : ''}
          >
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-neutral-600 dark:text-neutral-400 mt-2 grid grid-cols-1 md:grid-cols-2 gap-x-6">
                    ...
                    {repair.estimatedCost && (
                      <p>Estimated: €{repair.estimatedCost}</p>
                    )}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {repair.status !== 'COMPLETED' &&
                    repair.status !== 'CANCELLED' && (
                      <Link
                        href={`/${locale}/specialist/repairs/${repair.id}?action=complete`}
                      >
