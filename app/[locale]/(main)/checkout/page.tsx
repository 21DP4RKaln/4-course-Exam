...
function CheckoutForm() {
  ...
  const isShippingInView = useInView(shippingRef, {
    once: false,
    margin: '-100px',
    amount: 0.2,
  });
  ...
  const onSubmit = async (data: CheckoutFormData) => {
    try {
      ...
      const shippingRate = shippingRates.find(
        rate => rate.method === selectedShipping
      );
      ...
      if (data.paymentMethod === 'card') {
        try {
          ...
          if (
            ...
            /^https?:\/\//.test(responseData.sessionUrl)
          ) {
          ...
          setPaymentError(
            error instanceof Error ? error.message : t('checkout.stripeError')
          );
          return;
        }
      }
              ...
              <label className="flex items-start">
                ...
                <div>
                  ...
                  <div className="text-neutral-600 dark:text-neutral-400">
                    ...
                    <br />
                    {user.shippingCity}, {user.shippingPostalCode}
                    <br />
      ...
      >
        ...
        >
          ...
          <div className="flex justify-between text-neutral-600 dark:text-neutral-400">
            <span>
              {t('checkout.subtotal')} ({items.length} {t('checkout.items')})
            </span>
          ...
          {selectedShipping && (
            ...
            >
              ...
              <span>
                {shippingRates.find(rate => rate.method === selectedShipping)
                  ?.rate === 0
                  ? t('checkout.free')
