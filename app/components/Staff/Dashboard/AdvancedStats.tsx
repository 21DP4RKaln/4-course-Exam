      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[...Array(8)].map((_, i) => (
            <div
              key={i}
              className="h-32 bg-neutral-100 dark:bg-stone-950 rounded-lg animate-pulse"
            />
          ))}
        </div>
      </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatsCard
          ...
          trend={{
            value: Math.round(
              (stats.ordersThisMonth / stats.totalOrders) * 100
            ),
            isPositive: true,
          }}
        ...
        <StatsCard
          ...
          trend={{
            value: Math.round(
              (stats.revenueThisMonth / stats.totalRevenue) * 100
            ),
            isPositive: true,
          }}
