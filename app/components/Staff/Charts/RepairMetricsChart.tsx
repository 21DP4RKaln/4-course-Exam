        ...
        <div className="h-[400px]">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
              ...
              />
              <Legend />
              <Bar dataKey="pending" fill={chartColors.pending} name={t('admin.charts.pending')} />
              <Bar dataKey="inProgress" fill={chartColors.inProgress} name={t('admin.charts.inProgress')} />
              <Bar dataKey="completed" fill={chartColors.completed} name={t('admin.charts.completed')} />
              <Bar dataKey="cancelled" fill={chartColors.cancelled} name={t('admin.charts.cancelled')} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
