...
export function ComponentList() {
  ...
  const filteredComponents = components.filter(component =>
    ...
    component.category.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
      ...
      render: (value: number) => (
        <div className="flex items-center space-x-2">
          ...
          <StatusBadge 
            ...
            variant={getStockStatus(value) === 'IN_STOCK' ? 'success' : 
                    getStockStatus(value) === 'LOW_STOCK' ? 'warning' : 'danger'}
          />
        </div>
      )
    },
