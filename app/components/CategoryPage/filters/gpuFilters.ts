...
export const createGpuFilterGroups = (components: Component[]): FilterGroup[] => {
  ...
  components.forEach(c => {
    const architecture = c.specifications?.['Architecture'] || c.specifications?.['architecture'] || 
                  c.specifications?.['Product Architecture'] || c.specifications?.['productArchitecture'];
  ...
  components.forEach(c => {
    const memory = c.specifications?.['Memory'] || c.specifications?.['VRAM'] || 
                  c.specifications?.['memory'] || c.specifications?.['vram'] ||
                  c.specifications?.['Video Memory'] || c.specifications?.['videoMemory']
  ...
  components.forEach(c => {
    const memType = c.specifications?.['Memory Type'] || c.specifications?.['memoryType']
  ...
  components.forEach(c => {
    const fans = c.specifications?.['Fan Count'] || c.specifications?.['fanCount'] || 
                c.specifications?.['Fans'] || c.specifications?.['fans']
  ...
  components.forEach(c => {
    const chipType = c.specifications?.['Chip Type'] || c.specifications?.['chipType'] || 
                    c.specifications?.['GPU'] || c.specifications?.['gpu']
  ...
  components.forEach(c => {
    const hdmi = c.specifications?.['HDMI Port'] || c.specifications?.['hdmiPort'] || 
                c.specifications?.['HDMI'] || c.specifications?.['hdmi']
  ...
  components.forEach(c => {
    const dp = c.specifications?.['DisplayPort'] || c.specifications?.['displayPort']
  ...
  components.forEach(c => {
    const dvi = c.specifications?.['DVI Port'] || c.specifications?.['dviPort'] ||
               c.specifications?.['DVI'] || c.specifications?.['dvi']
  ...
  components.forEach(c => {
    const vga = c.specifications?.['VGA Port'] || c.specifications?.['vgaPort'] ||
               c.specifications?.['VGA'] || c.specifications?.['vga']
