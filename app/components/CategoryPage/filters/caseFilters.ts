...
export const createCaseFilterGroups = (
  ...
  components.forEach(c => {
    const material =
      c.specifications?.['Material'] || c.specifications?.['material'];
  ...
  components.forEach(c => {
    const audioIn =
      c.specifications?.['Audio In'] || c.specifications?.['audioIn'];
  ...
  components.forEach(c => {
    const audioOut =
      c.specifications?.['Audio Out'] || c.specifications?.['audioOut'];
  ...
  components.forEach(c => {
    const usb20Ports =
      c.specifications?.['USB 2.0 Ports'] ||
  ...
  components.forEach(c => {
    const usb30Ports =
      c.specifications?.['USB 3.0 Ports'] ||
  ...
  components.forEach(c => {
    const usb32Ports =
      c.specifications?.['USB 3.2 Ports'] ||
  ...
  components.forEach(c => {
    const usbTypeCPorts =
      c.specifications?.['USB Type-C Ports'] ||
  ...
  components.forEach(c => {
    const waterCooling =
      c.specifications?.['Water Cooling'] ||
