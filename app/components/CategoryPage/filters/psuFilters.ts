...
export const createPsuFilterGroups = (
  ...
  components.forEach(c => {
    const modularity =
      c.specifications?.['Modularity'] ||
      c.specifications?.['modularity'] ||
      c.specifications?.['Modular'];
    if (modularity) {
 ...
 */
export const filterPsuComponents = (
  components: Component[],
  ...
  return components.filter(component => {
    for (const [filterId, isActive] of Object.entries(activeFilters)) {
      ...
      switch (filterType) {
        case 'wattage':
          const wattage =
            component.specifications?.['Wattage'] ||
            component.specifications?.['wattage'] ||
        ...
        case 'modularity':
          const modularity =
            component.specifications?.['Modularity'] ||
            component.specifications?.['modularity'] ||
            component.specifications?.['Modular'];
