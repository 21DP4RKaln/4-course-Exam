  ...
  const services = [
    {
      ...
      icon: (
        <Wrench
          className={`h-10 w-10 ${theme === 'dark' ? 'text-brand-red-500' : 'text-brand-blue-500'}`}
        />
      ),
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Service title */}
              <h3
                className={`text-lg md:text-xl font-bold mb-2 md:mb-3 group-hover:${
                  theme === 'dark'
                    ? 'text-brand-red-400'
                    : 'text-brand-blue-600'
                } transition-colors ${
        ...
        <motion.div
          className={`mt-16 md:mt-24 rounded-xl md:rounded-2xl overflow-hidden ${
            theme === 'dark'
              ? 'bg-dark-card border border-stone-950'
