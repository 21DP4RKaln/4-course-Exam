...
import { analyzePasswordStrength, getPasswordStrengthColor, getPasswordStrengthTextColor } from '@/lib/passwordStrength';
...
export default function NewPasswordForm({
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6">      <div className="text-center">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">        <div className="space-y-2">
        ...
        {(validationError || error) && (
          ...
          <p className="text-sm font-medium text-gray-700 dark:text-gray-300">{t('passwordRequirements')}</p>
