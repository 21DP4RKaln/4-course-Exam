...
const CompatibilityPage: React.FC<CompatibilityPageProps> = ({
  selectedComponents,
  ...
  useEffect(() => {
    const newIssues = getCompatibilityIssues(
      selectedComponents,
      totalPowerConsumption,
      t
    );
    ...
    <div className="p-4 bg-white dark:bg-stone-950 rounded-lg shadow-lg">
      ...
      {issues.length === 0 ? (
        <p className="text-green-600">
          {t('configurator.compatibility.noIssues')}
        </p>
      ) : (
