...
const ComponentCard: React.FC<ComponentCardProps> = ({
  ...
  const getComponentImage = () => {
    ...
    if (component.imageUrl) {
      return (
        <div
          className={`${bgColor} h-16 w-16 rounded-lg overflow-hidden flex items-center justify-center`}
        >
          <img
    ...
    return (
      <div
        className={`${bgColor} h-16 w-16 rounded-lg flex items-center justify-center`}
      >
  ...
  if (
    component.categoryId === 'networking' ||
    component.categoryId === 'sound-cards'
  ) {
    return null;
  }
  return (
