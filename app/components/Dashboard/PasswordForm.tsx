...
export default function PasswordForm({ data, error, onChange }: PasswordFormProps) {
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        <div>
          ...
          <div className="relative">
            ...
            >
              {showPassword ? (
                <EyeOff size={18} className="text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300" />
              ) : (
                <Eye size={18} className="text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300" />
              )}
            </button>
          </div>
        </div>
