  ...
  if (loading) {
    return (
      ...
      >
        ...
        <span className="text-neutral-600 dark:text-neutral-400">Loading configurations...</span>
      </motion.div>
    )
  }
      ...
      <div className="flex justify-between items-center">
        ...
        {configurations.map((config) => (
          <ConfigurationCard
            ...
            locale={locale}
            onEdit={(configId) => router.push(`/${locale}/configurator?edit=${configId}`)}
            onOrder={(configId) => router.push(`/${locale}/shop/product/${configId}`)}
          />
        ))}
      </div>
    </motion.div>
