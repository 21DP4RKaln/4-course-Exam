              ...
              <div className="main">
                <div className="card">
                  <svg fillRule="nonzero" height="30px" width="30px" viewBox="0,0,256,256" className="instagram">
                    <g style={{mixBlendMode: 'normal'}} textAnchor="none" fontSize="none" fontWeight="none" fontFamily="none">
                ...
                <div className="card">
                  <svg height="30px" width="30px" viewBox="0 0 50 50" className="codepen">
                ...
                <div className="card">
                  <svg height="23px" width="23px" viewBox="0 0 100 100" className="uiverse">
                ...
                <div className="card">
                  <svg height="30px" width="30px" viewBox="0 0 48 48" className="discord">
                ...
                <div className="card">
                  <svg height="30px" width="30px" viewBox="0 0 48 48" className="telegram">
                ...
                <div className="card">
                  <svg height={30} width={30} viewBox="0 0 256 256" className="reddit">
                    <defs />
...
{/* Footer component styles using styled-components */}
const StyledWrapper = styled.div`
  .main_back {
    ...
    background: ${props => props.theme === 'dark' 
      ? 'linear-gradient(270deg, #b91c1c, #e11d48, #f43f5e)' 
      : 'linear-gradient(270deg, #2563eb, #1d4ed8, #1e40af)'};
    z-index: -2;
    box-shadow: inset 0px 0px 180px 5px ${props => props.theme === 'dark' ? '#030712' : '#f8fafc'};
  }
  ...
  .card .instagram {
    fill: ${props => props.theme === 'dark' ? '#e53e3e' : '#3182ce'};
  }
  ...
  .card .codepen {
    fill: ${props => props.theme === 'dark' ? '#f3f4f6' : '#1f2937'};
  }
  ...
  .main:hover .card:nth-child(1) {
    background-color: ${props => props.theme === 'dark' ? '#dc2626' : '#2563eb'};
  }

  .main:hover .card:nth-child(1) .instagram {
    fill: white;
  }

  .main:hover .card:nth-child(2) {
    background-color: ${props => props.theme === 'dark' ? '#dc2626' : '#2563eb'};
  }

  .main:hover .card:nth-child(2) .twitter {
    fill: white;
  }
  ...
  .main:hover .card:nth-child(3) .dribble {
    fill: white;
  }

  .main:hover .card:nth-child(4) {
    background-color: ${props => props.theme === 'dark' ? '#111827' : '#1f2937'};
  }

  .main:hover .card:nth-child(4) .codepen {
    fill: white;
  }

  .main:hover .card:nth-child(5) {
    animation: ${props => props.theme === 'dark' ? 'backgroundIMGDark' : 'backgroundIMGLight'} 0.1s;
    animation-fill-mode: forwards;
  }

  .main:hover .card:nth-child(5) .uiverse #paint0_linear_501_142 stop {
    stop-color: white;
  }

  .main:hover .card:nth-child(5) .uiverse #paint1_linear_501_142 stop {
    stop-color: white;
  }

  .main:hover .card:nth-child(5) .uiverse #paint2_linear_501_142 stop {
    stop-color: white;
  }

  .main:hover .card:nth-child(6) {
    background-color: ${props => props.theme === 'dark' ? '#dc2626' : '#2563eb'};
  }

  .main:hover .card:nth-child(6) .discord {
    fill: white;
  }
  ...
  .main:hover .card:nth-child(7) .github {
    fill: white;
  }

  .main:hover .card:nth-child(8) {
    background-color: ${props => props.theme === 'dark' ? '#dc2626' : '#2563eb'};
  }

  .main:hover .card:nth-child(8) .telegram > path:nth-of-type(1) {
    fill: white;
  }

  .main:hover .card:nth-child(8) .telegram > path:nth-of-type(2) {
    fill: ${props => props.theme === 'dark' ? '#dc2626' : '#2563eb'};
  }

  .main:hover .card:nth-child(8) .telegram > path:nth-of-type(3) {
    fill: ${props => props.theme === 'dark' ? '#dc2626' : '#2563eb'};
  }
  ...
  .main:hover .card:nth-child(9) .reddit > g circle {
    fill: ${props => props.theme === 'dark' ? '#dc2626' : '#2563eb'};
  }

  .main:hover .card:nth-child(9) .reddit > g path {
    fill: white;
  }
  ...
  @keyframes backgroundIMGDark {
    100% {
      background-image: linear-gradient(#dc2626, #b91c1c, #991b1b);
    }
  }

  @keyframes backgroundIMGLight {
    100% {
      background-image: linear-gradient(#2563eb, #1d4ed8, #1e40af);
    }
  }
`;