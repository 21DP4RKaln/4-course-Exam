...
export default function ReadyConfigManagement() {
  ...
  const fetchConfigurations = async () => {
    try {
      setLoading(true);
      const response = await fetch('/api/admin/ready-configs', {
        method: 'GET',
        cache: 'no-store',
        headers: {
  ...
  const handleDeleteConfiguration = async (id: string) => {
    if (confirm(t('confirmDelete'))) {
      try {
        setDeleteLoading(id);
        const response = await fetch(`/api/admin/ready-configs/${id}`, {
          method: 'DELETE',
        });
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex space-x-4">
          ...
          <Link
            href={`/${locale}/manage-ready-configs/new`}
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="mt-4 flex space-x-2">
                  <Link
                    href={`/${locale}/manage-ready-configs/${config.id}`}
