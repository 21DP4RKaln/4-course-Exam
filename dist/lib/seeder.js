...
async function seedSpecificationKeys() {
    ...
    for (const key of specKeys) {
        await prisma.specificationKey.upsert({
            ...
            update: {},
            create: Object.assign({ name: key.name, displayName: key.displayName }, (key.categoryId ? {
                componentCategory: {
...
async function seedComponents() {
    ...
    const psus = [
        ...
        {
            id: 'psu-thermaltake-850',
            name: 'Thermaltake Toughpower GF3 850W 80+ Gold',
            description: 'High-efficiency modular power supply with quiet operation',
            price: 159.99,
            stock: 18,
            sku: 'PSU-THERMALTAKE-GF3-850',
            categoryId: 'psu',
            specifications: JSON.stringify({
                color: 'Black',
                cabling: 'Fully Modular'
        ...
        },
        {
            ...
            description: 'Next-gen ready power supply with PCIe 5.0 support',
            price: 209.99,
            stock: 12,
            sku: 'PSU-MSI-MPG-1000',
            categoryId: 'psu',
            specifications: JSON.stringify({
                color: 'Black',
                cabling: 'Fully Modular'
        ...
        },
        {
            ...
            description: 'High-wattage platinum rated power supply for extreme builds',
            price: 269.99,
            stock: 8,
            sku: 'PSU-CORSAIR-HX1200',
            categoryId: 'psu',
            specifications: JSON.stringify({
                color: 'Black',
                cabling: 'Fully Modular'
        ...
        },
        {
            ...
            description: 'Premium power supply with titanium efficiency',
            price: 329.99,
            stock: 6,
            sku: 'PSU-BEQUIET-DP13-1000',
            categoryId: 'psu',
            specifications: JSON.stringify({
                color: 'Black',
                cabling: 'Fully Modular'
            ...
            specValues: [
                ...
                { name: 'wattage', value: '1000W' },
                { name: 'efficiency', value: '80+ Titanium' },
                { name: 'modular', value: 'Fully Modular' },
                { name: 'warranty', value: '10 Years' }
            ]
        },
        {
            id: 'psu-evga-750-bq',
            name: 'EVGA 750 BQ 750W 80+ Bronze',
            description: 'Reliable semi-modular power supply for budget builds',
            price: 84.99,
            stock: 25,
            sku: 'PSU-EVGA-750BQ',
            categoryId: 'psu',
            ...
            specValues: [
                { name: 'brand', value: 'EVGA' },
                { name: 'wattage', value: '750W' },
                { name: 'efficiency', value: '80+ Bronze' },
                { name: 'modular', value: 'Semi-Modular' },
                { name: 'warranty', value: '5 Years' }
            ]
        },
        {
            id: 'psu-silverstone-sfx-700',
            name: 'SilverStone SX700-PT 700W SFX 80+ Platinum',
            ...
            specValues: [
                { name: 'brand', value: 'SilverStone' },
                { name: 'wattage', value: '700W' },
                { name: 'efficiency', value: '80+ Platinum' },
                { name: 'modular', value: 'Fully Modular' },
                { name: 'warranty', value: '5 Years' }
            ]
        ...
        {
            id: 'psu-fractal-ion-gold-850',
            name: 'Fractal Design Ion+ 2 850W 80+ Gold',
            description: 'High-quality modular PSU with ultra-flexible cables',
            price: 149.99,
            stock: 20,
            sku: 'PSU-FRACTAL-ION-850',
            categoryId: 'psu',
            specifications: JSON.stringify({
                color: 'Black',
                cabling: 'Fully Modular'
    ...
    const cases = [
        ...
        },
        {
            ...
            description: 'High-airflow case with RGB and excellent build quality',
            price: 149.99,
            stock: 16,
            ...
            specifications: JSON.stringify({
                sides: 'Tempered Glass',
                included: '3x 140mm D-RGB Fans'
            }),
            specValues: [
                { name: 'brand', value: 'Phanteks' },
                { name: 'type', value: 'Mid Tower' },
                { name: 'formFactor', value: 'ATX, Micro-ATX, Mini-ITX' },
                { name: 'color', value: 'Black' },
                { name: 'dimensions', value: '465mm x 230mm x 510mm' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            ...
            price: 109.99,
            stock: 22,
            sku: 'CASE-BEQUIET-500DX',
            categoryId: 'case',
            specifications: JSON.stringify({
                sides: 'Tempered Glass',
                included: '3x Pure Wings 2 140mm'
            }),
            specValues: [
                { name: 'brand', value: 'be quiet!' },
                { name: 'type', value: 'Mid Tower' },
                ...
                { name: 'dimensions', value: '450mm x 231mm x 463mm' },
                { name: 'warranty', value: '3 Years' }
            ]
        },
        {
            ...
            name: 'NZXT H7 Flow',
            description: 'Modern minimalist case with excellent airflow',
            price: 129.99,
            stock: 20,
            ...
            specValues: [
                ...
                { name: 'dimensions', value: '480mm x 230mm x 505mm' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            ...
            description: 'Premium Mini-ITX case with versatile configuration options',
            price: 99.99,
            stock: 25,
            sku: 'CASE-CM-NR200P',
            categoryId: 'case',
            specifications: JSON.stringify({
                sides: 'Tempered Glass + Mesh Panel',
                included: '2x 120mm Fans'
            }),
            specValues: [
                { name: 'brand', value: 'Cooler Master' },
                { name: 'type', value: 'Mini-ITX' },
                { name: 'formFactor', value: 'Mini-ITX, DTX' },
                { name: 'color', value: 'Black' },
                { name: 'dimensions', value: '360mm x 185mm x 274mm' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            id: 'case-phanteks-evolv-x',
            name: 'Phanteks Evolv X',
            description: 'Premium dual-system capable case with RGB',
            price: 219.99,
            stock: 8,
            sku: 'CASE-PHANTEKS-EVOLV-X',
            categoryId: 'case',
            specifications: JSON.stringify({
                sides: 'Dual Tempered Glass',
                included: '3x 140mm Fans'
            }),
            specValues: [
                { name: 'brand', value: 'Phanteks' },
                { name: 'type', value: 'Full Tower' },
                { name: 'formFactor', value: 'E-ATX, ATX, Micro-ATX, Mini-ITX' },
                { name: 'color', value: 'Anthracite Grey' },
                { name: 'dimensions', value: '520mm x 240mm x 510mm' },
                { name: 'warranty', value: '5 Years' }
            ]
        },
        {
            id: 'case-meshify-mini-c',
            name: 'Fractal Design Meshify C Mini',
            description: 'Compact micro-ATX case with excellent airflow',
            price: 99.99,
            stock: 20,
            sku: 'CASE-FRACTAL-MESHIFY-MINI',
            categoryId: 'case',
            specifications: JSON.stringify({
                sides: 'Tempered Glass',
                included: '2x Dynamic X2 GP-12 Fans'
            }),
            specValues: [
                { name: 'brand', value: 'Fractal Design' },
                { name: 'type', value: 'Micro-ATX Tower' },
                { name: 'formFactor', value: 'Micro-ATX, Mini-ITX' },
                { name: 'color', value: 'Black' },
                { name: 'dimensions', value: '395mm x 212mm x 409mm' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            id: 'case-thermaltake-tower900',
            name: 'Thermaltake Tower 900',
            description: 'E-ATX vertical super tower case',
            price: 279.99,
            stock: 5,
            sku: 'CASE-THERMALTAKE-TOWER900',
            categoryId: 'case',
            specifications: JSON.stringify({
                sides: 'Multiple Tempered Glass',
                included: '2x 140mm Fans'
            }),
            specValues: [
                { name: 'brand', value: 'Thermaltake' },
                { name: 'type', value: 'Super Tower' },
                { name: 'formFactor', value: 'E-ATX, ATX, Micro-ATX, Mini-ITX' },
                { name: 'color', value: 'Black' },
                { name: 'dimensions', value: '752mm x 423mm x 483mm' },
                { name: 'warranty', value: '3 Years' }
            ]
        }
    ];
    ...
    const coolings = [
        ...
        {
            id: 'cooling-ekwb-aio-360',
            name: 'EKWB EK-AIO Elite 360 D-RGB',
            description: 'Premium 360mm AIO with high-performance fans',
            price: 199.99,
            stock: 10,
            sku: 'COOL-EKWB-AIO360',
            categoryId: 'cooling',
            specifications: JSON.stringify({
                color: 'Black',
                rgb: 'Yes'
            ...
            specValues: [
                { name: 'brand', value: 'EKWB' },
                { name: 'type', value: 'Liquid Cooler (AIO)' },
                { name: 'radiatorSize', value: '360mm' },
                { name: 'fanSize', value: '6x 120mm' },
                { name: 'noise', value: '15-38 dBA' },
                { name: 'warranty', value: '5 Years' }
            ]
        },
        {
            id: 'cooling-arctic-liquid-420',
            name: 'Arctic Liquid Freezer II 420',
            description: 'High-performance 420mm AIO liquid cooler',
            price: 159.99,
            stock: 8,
            sku: 'COOL-ARCTIC-LF420',
            categoryId: 'cooling',
            specifications: JSON.stringify({
                color: 'Black',
                rgb: 'No'
            ...
            specValues: [
                { name: 'brand', value: 'Arctic' },
                { name: 'type', value: 'Liquid Cooler (AIO)' },
                { name: 'radiatorSize', value: '420mm' },
                { name: 'fanSize', value: '3x 140mm' },
                { name: 'noise', value: '0.3 Sone' },
                { name: 'warranty', value: '6 Years' }
            ]
        },
        {
            ...
            specValues: [
                { name: 'brand', value: 'DeepCool' },
                { name: 'type', value: 'Air Cooler' },
                { name: 'fanSize', value: '2x 120mm' },
                { name: 'noise', value: '28 dBA' },
                { name: 'warranty', value: '3 Years' }
            ]
        },
        {
            id: 'cooling-scythe-fuma2',
            name: 'Scythe FUMA 2 Rev.B',
            description: 'Dual tower air cooler with excellent RAM compatibility',
            price: 65.99,
            stock: 25,
            ...
            specValues: [
                { name: 'brand', value: 'Scythe' },
                { name: 'type', value: 'Air Cooler' },
                { name: 'fanSize', value: '2x 120mm' },
                { name: 'noise', value: '23.9 dBA' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            id: 'cooling-thermaltake-toughliquid',
            name: 'Thermaltake ToughLiquid Ultra 360',
            description: 'LCD display AIO with premium cooling performance',
            price: 229.99,
            stock: 12,
            sku: 'COOL-TT-ULTRA360',
            categoryId: 'cooling',
            specifications: JSON.stringify({
                color: 'Black',
                rgb: 'Yes'
            ...
            specValues: [
                ...
                { name: 'radiatorSize', value: '360mm' },
                { name: 'fanSize', value: '3x 120mm' },
                { name: 'noise', value: '22-33 dBA' },
                { name: 'warranty', value: '5 Years' }
            ]
        },
        {
            id: 'cooling-bequiet-pure-rock2',
            ...
            specValues: [
                { name: 'brand', value: 'be quiet!' },
                { name: 'type', value: 'Air Cooler' },
                { name: 'fanSize', value: '1x 120mm' },
                { name: 'noise', value: '26.8 dBA' },
                { name: 'warranty', value: '3 Years' }
            ]
        },
        {
            id: 'cooling-msi-coreliquid-240',
            name: 'MSI MAG CoreLiquid P240',
            description: 'RGB AIO liquid cooler with silent operation',
            price: 129.99,
            stock: 18,
            sku: 'COOL-MSI-P240',
            categoryId: 'cooling',
            ...
            specValues: [
                { name: 'brand', value: 'MSI' },
                { name: 'type', value: 'Liquid Cooler (AIO)' },
                { name: 'radiatorSize', value: '240mm' },
                { name: 'fanSize', value: '2x 120mm' },
                { name: 'noise', value: '14-34 dBA' },
                { name: 'warranty', value: '3 Years' }
            ]
        }
    ];
    ...
    const keyboards = [
        ...
        {
            id: 'keyboard-razer-huntsman',
            name: 'Razer Huntsman V2 Analog',
            description: 'Premium optical-mechanical keyboard with analog switches',
            price: 249.99,
            stock: 10,
            sku: 'KB-RAZER-HUNTSMAN-V2',
            categoryId: 'keyboards',
            specifications: JSON.stringify({
            ...
            specValues: [
                ...
                { name: 'switchType', value: 'Razer Analog Optical' },
                { name: 'backlight', value: 'RGB' },
                { name: 'connection', value: 'Wired USB-C' },
                { name: 'warranty', value: '2 Years' }
            ]
        ...
        {
            id: 'keyboard-varmilo-va87m',
            name: 'Varmilo VA87M Sakura',
            description: 'High-quality TKL mechanical keyboard with Cherry MX switches',
            price: 139.99,
            stock: 15,
            sku: 'KB-VARMILO-VA87M',
            categoryId: 'keyboards',
            specifications: JSON.stringify({
                keycaps: 'Dye-Sub PBT',
                mediaControls: 'No'
            ...
            specValues: [
                { name: 'brand', value: 'Varmilo' },
                { name: 'switchType', value: 'Cherry MX Silent Red' },
                { name: 'backlight', value: 'White' },
                { name: 'connection', value: 'Wired USB-C' },
                { name: 'warranty', value: '1 Year' }
            ]
        },
        {
            id: 'keyboard-das-professional',
            name: 'Das Keyboard 6 Professional',
            description: 'Premium full-size mechanical keyboard for professionals',
            price: 199.99,
            stock: 12,
            sku: 'KB-DAS-PRO6',
            categoryId: 'keyboards',
            ...
            specValues: [
                { name: 'brand', value: 'Das Keyboard' },
                { name: 'switchType', value: 'Cherry MX Blue' },
                { name: 'backlight', value: 'White' },
                { name: 'connection', value: 'Wired USB-C' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            ...
            name: 'Wooting 60HE',
            description: 'Compact analog mechanical keyboard for gaming',
            price: 189.99,
            stock: 8,
            sku: 'KB-WOOTING-60HE',
            categoryId: 'keyboards',
            ...
            specValues: [
                { name: 'brand', value: 'Wooting' },
                { name: 'switchType', value: 'Lekker (Hall Effect)' },
                { name: 'backlight', value: 'RGB' },
                { name: 'connection', value: 'Wired USB-C' },
                { name: 'warranty', value: '2 Years' }
            ]
        ...
        {
            id: 'keyboard-leopold-fc900r',
            name: 'Leopold FC900R PD',
            description: 'High-quality full-size mechanical keyboard',
            price: 129.99,
            stock: 10,
            sku: 'KB-LEOPOLD-FC900R',
            categoryId: 'keyboards',
            specifications: JSON.stringify({
            ...
            specValues: [
                { name: 'brand', value: 'Leopold' },
                { name: 'switchType', value: 'Cherry MX Clear' },
                { name: 'backlight', value: 'None' },
                { name: 'connection', value: 'Wired USB' },
                { name: 'warranty', value: '1 Year' }
            ]
        },
        {
            id: 'keyboard-hhkb-pro3',
            name: 'HHKB Professional HYBRID Type-S',
            description: 'Premium Topre switch keyboard with wireless capability',
            price: 299.99,
            stock: 5,
            sku: 'KB-HHKB-PRO3',
            categoryId: 'keyboards',
            ...
            specValues: [
                { name: 'brand', value: 'HHKB' },
                { name: 'switchType', value: 'Topre 45g Silent' },
                { name: 'backlight', value: 'None' },
    ...
    const mice = [
        ...
        {
            id: 'mouse-endgame-xm1r',
            name: 'Endgame Gear XM1r',
            description: 'Professional FPS gaming mouse with ultra-low latency',
            price: 79.99,
            stock: 20,
            sku: 'MOUSE-ENDGAME-XM1R',
            categoryId: 'mice',
            specifications: JSON.stringify({
                color: 'Dark Frost',
                weight: '70g'
            ...
            specValues: [
                { name: 'brand', value: 'Endgame Gear' },
                { name: 'sensor', value: 'PixArt PAW3370' },
                { name: 'dpi', value: 'Up to 19,000 DPI' },
                { name: 'buttons', value: '5' },
                { name: 'warranty', value: '2 Years' }
            ]
        ...
        {
            id: 'mouse-zowie-ec2-c',
            name: 'ZOWIE EC2-C',
            description: 'Professional esports mouse with ergonomic design',
            price: 69.99,
            stock: 25,
            sku: 'MOUSE-ZOWIE-EC2C',
            categoryId: 'mice',
            specifications: JSON.stringify({
                color: 'Black',
                weight: '73g'
            ...
            specValues: [
                { name: 'brand', value: 'ZOWIE' },
                { name: 'sensor', value: '3360' },
                { name: 'dpi', value: 'Up to 3,200 DPI' },
                { name: 'buttons', value: '5' },
                { name: 'warranty', value: '1 Year' }
            ]
        },
        {
            id: 'mouse-roccat-kone',
            name: 'ROCCAT Kone Pro Air',
            description: 'Lightweight wireless ergonomic gaming mouse',
            price: 129.99,
            stock: 15,
            sku: 'MOUSE-ROCCAT-KONEPRO',
            categoryId: 'mice',
            specifications: JSON.stringify({
                color: 'White',
                weight: '75g'
            ...
            specValues: [
                { name: 'brand', value: 'ROCCAT' },
                { name: 'sensor', value: 'Owl-Eye 19K' },
                { name: 'dpi', value: 'Up to 19,000 DPI' },
                { name: 'buttons', value: '6' },
                { name: 'warranty', value: '2 Years' }
            ]
        ...
        {
            id: 'mouse-corsair-sabre',
            name: 'Corsair SABRE RGB PRO WIRELESS',
            description: 'Ultra-lightweight wireless gaming mouse',
            price: 109.99,
            stock: 18,
            sku: 'MOUSE-CORSAIR-SABRE',
            categoryId: 'mice',
            specifications: JSON.stringify({
                color: 'Black',
                weight: '79g'
            ...
            specValues: [
                { name: 'brand', value: 'Corsair' },
                { name: 'sensor', value: 'MARKSMAN' },
                { name: 'dpi', value: 'Up to 26,000 DPI' },
        ...
        },
        {
            ...
            description: 'Modular wireless gaming mouse with swappable shells',
            price: 99.99,
            stock: 12,
            sku: 'MOUSE-XTRFY-M42',
            categoryId: 'mice',
            ...
            specValues: [
                { name: 'brand', value: 'Xtrfy' },
                { name: 'sensor', value: 'PixArt 3370' },
                { name: 'dpi', value: 'Up to 19,000 DPI' },
                { name: 'buttons', value: '6' },
                { name: 'warranty', value: '2 Years' }
            ]
    ...
    const monitors = [
        ...
        },
        {
            ...
            name: 'GIGABYTE M32U 32" 4K IPS Gaming Monitor',
            description: '32" 4K IPS gaming monitor with HDMI 2.1',
            price: 699.99,
            stock: 15,
            sku: 'MON-GIGABYTE-M32U',
            categoryId: 'monitors',
            specifications: JSON.stringify({
                hdr: 'HDR400',
        ...
        },
        {
            ...
            description: '27" WQHD IPS gaming monitor with G-SYNC',
            price: 799.99,
            stock: 12,
        ...
        {
            id: 'monitor-eve-spectrum-4k',
            name: 'Eve Spectrum ES07D03 4K',
            description: '27" 4K IPS monitor with USB-C',
            price: 799.99,
            stock: 8,
            sku: 'MON-EVE-SPECTRUM4K',
            categoryId: 'monitors',
            specifications: JSON.stringify({
                hdr: 'HDR600',
                inputs: 'HDMI 2.1, DisplayPort 1.4, USB-C'
        ...
        {
            id: 'monitor-viewsonic-xg320u',
            name: 'ViewSonic ELITE XG320U',
            description: '32" 4K gaming monitor with Mini LED',
            price: 999.99,
            stock: 10,
            sku: 'MON-VIEWSONIC-XG320U',
            categoryId: 'monitors',
            specifications: JSON.stringify({
                hdr: 'HDR1000',
                inputs: 'HDMI 2.1, DisplayPort 1.4'
            ...
            specValues: [
                { name: 'brand', value: 'ViewSonic' },
                { name: 'size', value: '32"' },
                { name: 'resolution', value: '3840 x 2160 (4K)' },
                { name: 'refreshRate', value: '150Hz' },
                { name: 'panelType', value: 'Mini LED' },
                { name: 'warranty', value: '3 Years' }
            ]
        },
        {
            id: 'monitor-huawei-mateview',
            name: 'HUAWEI MateView 28',
            description: '28" 4K+ professional monitor with unique aspect ratio',
            price: 699.99,
            stock: 15,
            sku: 'MON-HUAWEI-MATEVIEW',
            categoryId: 'monitors',
            specifications: JSON.stringify({
                hdr: 'HDR400',
                inputs: 'HDMI 2.0, MiniDP, USB-C'
            }),
            specValues: [
                { name: 'brand', value: 'HUAWEI' },
                { name: 'size', value: '28"' },
                { name: 'resolution', value: '3840 x 2560 (4K+)' },
        ...
        {
            id: 'monitor-dell-aw3423dwf',
            name: 'Dell Alienware AW3423DWF',
            description: '34" QD-OLED ultrawide gaming monitor with FreeSync',
            price: 999.99,
            stock: 7,
    ...
    const headphones = [
        ...
        {
            id: 'headphone-razer-blackshark-v2',
            name: 'Razer BlackShark V2 Pro',
            description: 'Professional-grade wireless gaming headset',
            price: 179.99,
            stock: 15,
            sku: 'HEAD-RAZER-BLACKSHARK-V2',
            categoryId: 'headphones',
            specifications: JSON.stringify({
                color: 'Black',
        ...
        },
        {
            ...
            specValues: [
                ...
                { name: 'micType', value: 'Detachable Broadcast' },
                { name: 'connection', value: 'Slipstream/USB/3.5mm' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            id: 'headphone-logitech-gpro-x',
            name: 'Logitech G PRO X Wireless',
            description: 'Professional gaming headset with Blue VO!CE technology',
            price: 199.99,
            stock: 18,
            sku: 'HEAD-LOGITECH-GPRO-X',
            categoryId: 'headphones',
            specifications: JSON.stringify({
                color: 'Black',
                batteryLife: '20 hours'
            ...
            specValues: [
                { name: 'brand', value: 'Logitech' },
                { name: 'type', value: 'Over-ear Wireless' },
                { name: 'driver', value: '50mm PRO-G' },
                { name: 'micType', value: 'Pro-grade Cardioid' },
                { name: 'connection', value: 'LIGHTSPEED Wireless' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            id: 'headphone-astro-a50',
            name: 'ASTRO Gaming A50 Wireless',
            description: 'Premium wireless gaming headset with charging base station',
            price: 299.99,
            stock: 10,
            sku: 'HEAD-ASTRO-A50',
            categoryId: 'headphones',
            ...
            specValues: [
                { name: 'brand', value: 'ASTRO' },
                { name: 'type', value: 'Over-ear Wireless' },
                { name: 'driver', value: '40mm Neodymium' },
                { name: 'micType', value: 'Flip-to-mute' },
                { name: 'connection', value: '2.4GHz with Base Station' },
                { name: 'warranty', value: '1 Year' }
            ]
        }
    ];
    ...
    const speakers = [
        ...
        {
            id: 'speaker-klipsch-promedia',
            name: 'Klipsch ProMedia 2.1 THX',
            description: 'THX-certified 2.1 speaker system for powerful audio',
            price: 149.99,
            stock: 20,
            sku: 'SPK-KLIPSCH-PROMEDIA',
            categoryId: 'speakers',
            specifications: JSON.stringify({
                color: 'Black',
                totalPower: '200W Peak'
            }),
            specValues: [
                { name: 'brand', value: 'Klipsch' },
                { name: 'type', value: '2.1 System' },
                { name: 'power', value: '200W Peak Power' },
                { name: 'connection', value: '3.5mm' },
                { name: 'features', value: 'THX Certified, Subwoofer' },
                { name: 'warranty', value: '1 Year' }
            ]
        },
        {
            id: 'speaker-creative-t100',
            name: 'Creative T100 2.0',
            description: 'Compact desktop speakers with multiple connectivity options',
            price: 99.99,
            stock: 25,
            sku: 'SPK-CREATIVE-T100',
            categoryId: 'speakers',
            specifications: JSON.stringify({
                color: 'Black',
                totalPower: '40W RMS'
            ...
            specValues: [
                { name: 'brand', value: 'Creative' },
                { name: 'type', value: '2.0 System' },
                { name: 'power', value: '40W RMS' },
                { name: 'connection', value: 'Bluetooth 5.0, 3.5mm, Optical' },
                { name: 'features', value: 'Digital Display, Remote Control' },
                { name: 'warranty', value: '1 Year' }
            ]
        },
        {
            id: 'speaker-razer-nommo-pro',
            name: 'Razer Nommo Pro',
            description: 'Premium 2.1 gaming speakers with THX certification',
            price: 499.99,
            stock: 10,
            sku: 'SPK-RAZER-NOMMOPRO',
            categoryId: 'speakers',
            specifications: JSON.stringify({
                color: 'Black',
                totalPower: '420W Peak'
            }),
            specValues: [
                { name: 'brand', value: 'Razer' },
                { name: 'type', value: '2.1 System' },
                { name: 'power', value: '420W Peak Power' },
                { name: 'connection', value: 'USB, Optical, Bluetooth' },
                { name: 'features', value: 'THX Certified, Chroma RGB' },
                { name: 'warranty', value: '2 Years' }
            ]
        }
    ];
    ...
    const gamepads = [
        ...
        {
            id: 'gamepad-nintendo-procon',
            name: 'Nintendo Switch Pro Controller',
            description: 'Official Nintendo Switch Pro Controller with motion controls',
            price: 69.99,
            stock: 15,
            sku: 'PAD-NINTENDO-PROCON',
            categoryId: 'gamepads',
            specifications: JSON.stringify({
                color: 'Black',
                batteryLife: 'Up to 40 hours'
            ...
            specValues: [
                ...
                { name: 'platform', value: 'Nintendo Switch/PC' },
                { name: 'connection', value: 'Bluetooth, USB-C' },
                { name: 'features', value: 'Motion controls, HD rumble, Amiibo support' },
                { name: 'warranty', value: '1 Year' }
            ]
        },
        {
            id: 'gamepad-razer-wolverine',
            name: 'Razer Wolverine V2 Pro',
            description: 'Premium wired controller with mechanical buttons',
            price: 149.99,
            stock: 8,
            sku: 'PAD-RAZER-WOLVERINE',
            categoryId: 'gamepads',
            specifications: JSON.stringify({
                color: 'Black',
                batteryLife: 'N/A (Wired)'
            ...
            specValues: [
                ...
                { name: 'platform', value: 'Xbox/PC' },
                { name: 'connection', value: 'Wired USB-C' },
                { name: 'features', value: 'Mechanical buttons, Extra triggers, RGB lighting' },
                { name: 'warranty', value: '2 Years' }
            ]
        },
        {
            id: 'gamepad-8bitdo-pro2',
            name: '8BitDo Pro 2 Bluetooth Controller',
            description: 'Versatile controller with retro design and modern features',
            price: 49.99,
            stock: 30,
            sku: 'PAD-8BITDO-PRO2',
            categoryId: 'gamepads',
            ...
            specValues: [
                { name: 'brand', value: '8BitDo' },
                { name: 'platform', value: 'Switch/PC/Mobile' },
                { name: 'connection', value: 'Bluetooth, USB-C' },
                { name: 'features', value: 'Customizable buttons, Multiple platform support' },
                { name: 'warranty', value: '1 Year' }
            ]
        }
    ];
    const additionalConfigurations = [
        {
            ...
            isTemplate: true,
            isPublic: true,
            status: client_1.ConfigStatus.APPROVED,
            components: [
        ...
        {
            id: 'config-budget-amd',
            name: 'Budget AMD Gaming Build',
            description: 'Cost-effective AMD-based gaming PC',
            isTemplate: true,
            isPublic: true,
            status: client_1.ConfigStatus.APPROVED,
            components: [
                { componentId: 'cpu-amd-ryzen5-7600x', quantity: 1 },
                { componentId: 'mb-asrock-b650-pg', quantity: 1 },
                { componentId: 'gpu-amd-rx7800xt', quantity: 1 },
        ...
        {
            id: 'config-professional-rendering',
            name: 'Professional 3D Rendering Workstation',
            description: 'High-end workstation for 3D rendering and professional work',
            isTemplate: true,
            isPublic: true,
            status: client_1.ConfigStatus.APPROVED,
            components: [
                ...
                { componentId: 'ram-crucial-64gb', quantity: 2 },
                { componentId: 'storage-samsung-980pro-2tb', quantity: 2 },
                { componentId: 'storage-wd-blue-4tb-hdd', quantity: 2 },
                { componentId: 'psu-evga-supernova-1000', quantity: 1 },
                ...
                for (const spec of component.specValues) {
                    ...
                    if (!specKey) {
                        specKey = await prisma.specificationKey.create({
                            data: Object.assign({ name: spec.name, displayName: spec.name.charAt(0).toUpperCase() + spec.name.slice(1) }, (component.categoryId ? {
                                componentCategory: {
    ...
    await prisma.promoCode.createMany({
        data: [{
            ...
            },
            {
                ...
                maxUsage: 50,
                usageCount: 0,
                expiresAt: new Date(Date.now() + 90 * 24 * 60 * 60 * 1000), // Valid for 90 days
                scope: 'ALL',
                isActive: true
            }
        ]
